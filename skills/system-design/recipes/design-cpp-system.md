...
updated: 2026-07-05
---
# Design C++ System Recipe

## Goal
Create a maintainable C++ system architecture that balances modularity, performance, and testability.

## Steps
1. Define core modules and layer responsibilities.
2. Use clear interfaces and avoid cyclic dependencies.
3. Separate platform-dependent code behind abstractions.
4. Use dependency injection for shared services.
5. Document ownership, lifetime, and threading requirements.

## Focus Areas
- module boundaries and interfaces
- memory ownership
- portability and platform-specific abstraction
- testability and dependency separation
