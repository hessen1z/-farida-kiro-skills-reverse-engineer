...
## Prompt
You are reviewing a system design for scalability and performance under load. Provide guidance on how to scale components, manage resources, and isolate bottlenecks.

## Context
- Focus on concurrent execution, service scaling, and resource partitioning.
- Identify shared state or coupling that limits horizontal scaling.
- Evaluate if the system architecture supports independent scaling.

## Output
- Summary of scalability and performance risks.
- Recommended architecture adjustments.
- Prioritized areas for scaling improvements.
