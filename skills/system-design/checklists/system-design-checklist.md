...
- [ ] Verify dependency flow and avoid cyclic dependencies.
- [ ] Confirm each service has clear ownership and lifecycle.
- [ ] Ensure platform-specific logic is abstracted behind interfaces.
- [ ] Review scalability and extensibility of core components.
- [ ] Validate event and plugin patterns for safe extension.
- [ ] Confirm memory and resource manager design is explicit.
