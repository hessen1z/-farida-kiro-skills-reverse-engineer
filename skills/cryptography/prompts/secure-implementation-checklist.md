...
## Prompt
You are reviewing a system for cryptographic correctness and secure implementation. Determine whether encryption, signing, and key management are implemented according to best practices.

## Context
- Review code that uses Windows CryptoAPI, CNG, or custom cryptographic routines.
- Identify insecure defaults, key reuse, and missing integrity checks.
- Emphasize secure storage and proper handling of secret material.

## Output
- A clear summary of cryptographic issues.
- Recommended changes to algorithms and key lifecycle.
- Any security risks introduced by current implementation.
