...
Requirements:
- describe the overall UI structure
- identify standard widgets versus custom DrawList visuals
- define the proposed component architecture
- include style, spacing, and layout notes
- mention scalability and DPI concerns
