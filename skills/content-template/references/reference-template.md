...
## Reference Title
- Describe the source or specification.

## Summary
- Summarize the contents and why it matters.

## Key Points
- List the most important items or concepts from the reference.

## Usage
- Explain how this reference should be applied in the repository.

## Related Topics
- Cross-reference other repository content that depends on this reference.

## Links
- Provide URLs, publication details, or document names.
