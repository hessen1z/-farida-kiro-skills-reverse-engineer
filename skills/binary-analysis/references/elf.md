...
- GNU binutils and ELF format documentation
- Linux dynamic linker and load-time relocation guides
- DWARF Debugging Standard references for ELF debug information
