...
- Windows Internals: Loader and PE formats
- Microsoft documentation: IMAGE_DOS_HEADER, IMAGE_NT_HEADERS, IMAGE_SECTION_HEADER
- PE header parsing guides and reverse engineering whitepapers
