...
- Define the detection objective and expected signal.
- Review rule logic and correlation conditions.
- Validate against positive and negative examples.
- Tune for false positives, latency, and operational cost.
