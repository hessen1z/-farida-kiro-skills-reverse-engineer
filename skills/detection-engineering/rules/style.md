...
- Emphasize telemetry fidelity, signal quality, and explainability.
- Distinguish detection logic from response actions.
- Always connect detections to validation and tuning workflows.
